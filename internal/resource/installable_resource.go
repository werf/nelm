...
func NewInstallableResource(res *id.ResourceSpec, releaseNamespace string, opts InstallableResourceOptions) (*InstallableResource, error) {
	...
	extDeps, err := externalDependencies(res.ResourceMeta, releaseNamespace, opts.Mapper, opts.DiscoveryClient)
	if err != nil {
	...
	return &InstallableResource{
		...
		Weight:                                 weight(res.ResourceMeta),
		ManualInternalDependencies:             manualInternalDependencies(res.ResourceMeta, releaseNamespace),
		AutoInternalDependencies:               autoInternalDependencies(res.Unstruct, releaseNamespace),
