...
// Load loads a chart
func (l FileLoader) Load(ctx context.Context) (*chart.Chart, error) {
	return LoadFile(ctx, string(l))
}

// LoadFile loads from an archive file.
func LoadFile(ctx context.Context, name string) (*chart.Chart, error) {
...
func LoadArchive(ctx context.Context, in io.Reader) (*chart.Chart, error) {
