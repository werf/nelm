...
func (l DirLoader) Load(ctx context.Context) (*chart.Chart, error) {
...
func LoadDir(ctx context.Context, dir string) (*chart.Chart, error) {
...
func getFilesFromLocalFilesystem(dir string) ([]*archive.BufferedFile, error) {
