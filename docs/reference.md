...
- `--lookup-resources` (default: `[]`)
  ...
  Manifest files used as a cluster stub for the lookup template function in non\-remote mode\. Vars: \$NELM\_LOOKUP\_RESOURCES\_\*, \$NELM\_CHART\_LINT\_LOOKUP\_RESOURCES\_\*
...
- `--lookup-resources` (default: `[]`)
  ...
  Manifest files used as a cluster stub for the lookup template function in non\-remote mode\. Vars: \$NELM\_LOOKUP\_RESOURCES\_\*, \$NELM\_CHART\_RENDER\_LOOKUP\_RESOURCES\_\*
