...
func NewLocalGeneralCR(unstruct *unstructured.Unstructured, filePath string, opts NewLocalGeneralCROptions) *LocalGeneralCR {
	return &LocalGeneralCR{
...
type NewLocalGeneralCROptions struct {
	Mapper          meta.ResettableRESTMapper
	DiscoveryClient discovery.CachedDiscoveryInterface
}

type LocalGeneralCR struct {
...
func (r *LocalGeneralCR) Validate() error {
