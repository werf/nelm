...
replace helm.sh/helm/v3 => github.com/werf/3p-helm/v3 v3.0.0-20231229193803-ecfe0905ab7c

replace github.com/werf/kubedog => github.com/werf/kubedog v0.12.1-0.20231229174621-812121cfb937
