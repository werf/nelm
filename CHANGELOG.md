...
## [2.0.0-alpha.1](https://github.com/werf/nelm/compare/v1.22.0...v2.0.0-alpha.1) (2026-09-25)
...
* add `renderPatches` support for --patches/patches.yaml ([#696](https://github.com/werf/nelm/issues/696)) ([191171c](https://github.com/werf/nelm/commit/191171c87ea1804baaaeb97c30b5b23399d9e58c))
...
* add LegacyPatches option for programmatic patches ([#720](https://github.com/werf/nelm/issues/720)) ([8103cd3](https://github.com/werf/nelm/commit/8103cd3dbbab31d5303d8a5515bb2ffed721f413))
...
* embed kubeconform validation schemas into the binary ([#673](https://github.com/werf/nelm/issues/673)) ([f6ce79b](https://github.com/werf/nelm/commit/f6ce79b3fd4cf716cf06d7de16f3073acf603182))
...
* move repo commands from root to chart repo ([#640](https://github.com/werf/nelm/issues/640)) ([ec0af5b](https://github.com/werf/nelm/commit/ec0af5b0ee1382045f09b68b762e8813a427f37b))
* native Chart v3 and Release v2 support ([ae98e04](https://github.com/werf/nelm/commit/ae98e045c5384ec776ce4991e850e4e1f82cc001))
* new major release 2.0 ([961ca04](https://github.com/werf/nelm/commit/961ca04a485a0f9b2d2ace0bb92c2f8b0f5bd93f))
* new release history ([074d350](https://github.com/werf/nelm/commit/074d3505764f00bc8a4d0f863b88bf988a44da74))
* port --lookup-resources and --no-create-namespace from main ([#671](https://github.com/werf/nelm/issues/671)) ([0d2b4e0](https://github.com/werf/nelm/commit/0d2b4e06f3a6d2cc5196a3ae3a02c4ce0e24ea90))
...
* support authenticated secret values ([#706](https://github.com/werf/nelm/issues/706)) ([16e45e2](https://github.com/werf/nelm/commit/16e45e2e628b2903e1060ed2086c559ee705d9ff))
...
* optimize `release get` ([6707d35](https://github.com/werf/nelm/commit/6707d353c5ab1f3dc0c01c9c3fb074564d76b047))
...
* register go-client auth plugins ([#670](https://github.com/werf/nelm/issues/670)) ([fec1159](https://github.com/werf/nelm/commit/fec11597241b54945e32bd9a924b0945ee379c47))
...
* repair ai lookup tests after helm fork api changes ([#676](https://github.com/werf/nelm/issues/676)) ([2a29517](https://github.com/werf/nelm/commit/2a29517d8d19ab606c5cd7cb24f55e3d394fabb5))
...
* release 2.0.0-alpha.1 ([f01be4d](https://github.com/werf/nelm/commit/f01be4d5c50ed4cb4f1e1ce4950022332bc7b214))
...
* enhanced local resource validation ([#545](https://github.com/werf/nelm/issues/545)) ([53505d1](https://github.com/werf/nelm/commit/53505d1c4ef6b32b1d57b2aa0d7d73471d5285e8))
...
* deploy/delete deps try to connect to later stages ([#557](https://github.com/werf/nelm/issues/557)) ([3823686](https://github.com/werf/nelm/commit/3823686e7a0d5919c4f769e66470ab124cf45ccf))
...
* major slowdown if node_modules in chart with TS enabled ([#558](https://github.com/werf/nelm/issues/558)) ([295d3e5](https://github.com/werf/nelm/commit/295d3e53763054f0045813b2f8979774ace0f7cc))
...
* force adoption always on ([#534](https://github.com/werf/nelm/issues/534)) ([5d5a6ee](https://github.com/werf/nelm/commit/5d5a6eeed00bd099a4b8cd1fe78b8922b904d457))
* new patcher for Secret, which coverts stringData to data ([9435670](https://github.com/werf/nelm/commit/94356704b6ee8b9a9440cd45ded889a0a22437c0))
* new patcher for Secret, which coverts stringData to data ([40e0b36](https://github.com/werf/nelm/commit/40e0b3638e2110fc83492513af4035d5cb4a7309))
